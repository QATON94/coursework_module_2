...
@pytest.mark.parametrize(
    "time_day_str, expected",
    [
        ("21.02.2021 19:40:55", "Добрый вечер!"),
...
def test_get_num_card(test_transactions):
    ...
    assert return_func == {
        "*4556": [{"cashback": 0, "last_digits": "*4556", "total_spent": 5000.0}],
    ...
    with patch("requests.get") as mock_get:
        mock_get.return_value.json.return_value = [
            ...
            },
            {
                ...
                "price": "238.83",
                "change_amount": "-1.25",
                "change_percentage": "-0.5207%",
                "volume": "120812848",
            },
            {
                "ticker": "PFE",
                "price": "28.8935",
                "change_amount": "-1.5765",
                "change_percentage": "-5.1739%",
                "volume": "103193120",
            },
            {
                "ticker": "ALT",
                "price": "3.57",
                "change_amount": "0.41",
                "change_percentage": "12.9747%",
                "volume": "100543793",
            },
        ]
    assert get_stock_prices(["BETS", "SQQQ"], None) == [
        {"price": "0.0388", "stock": "BETS"},
        {"price": "15.895", "stock": "SQQQ"},
    ]


def test_get_page_main():
    get_page_main(
        "Доброе утро!",
        {
            "*7197": [{"last_digits": "*7197", "total_spent": 2487419.5599999824, "cashback": 0}],
            "*5091": [{"last_digits": "*5091", "total_spent": 17367.500000000004, "cashback": 0}],
        },
        [
            {
        ...
        [{"currency": "USD", "rate": 89.7619}],
        [{"stock": "SQQQ", "price": "15.895"}, {"stock": "TSLA", "price": "238.83"}],
    )
    ...
    assert resault == {
        ...
        "currency_rates": [{"currency": "USD", "rate": 89.7619}],
        "stock_prices": [{"stock": "SQQQ", "price": "15.895"}, {"stock": "TSLA", "price": "238.83"}],
    }


def test_get_exchange_rate_err():
    get_exchange_rate(["DOC"]) == []


@patch.object(requests, "get")
def test_get_stock_prices_err(mock_get):
    mock_get.side_effect = requests.exceptions.HTTPError
    assert get_stock_prices(["USD"], "d") == []
