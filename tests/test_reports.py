...
def test_spending_by_category(test_transactions):
    ...
    filename = ROOT_PATH.joinpath("data", "Spending by category.csv")
    resault = []
    with open(filename, encoding="utf=8") as f:
        check_file = csv.reader(f)
        for row in check_file:
            resault.append(row)
    assert resault == [["{'Дата операции': '2019-07-16T16:30:10.000000000'", " 'Сумма платежа': -49.8}"], []]
